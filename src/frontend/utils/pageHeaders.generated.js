...
export const PAGE_HEADERS = {
  ...
  "overview/parts": ["Tables & Parts"],
  "overview/operations": ["Merges, Mutations & Replication"],
  "overview/ddl": ["Distributed DDL & Readonly Tables"],
  "overview/queues": [
    "Queues",
    "Throughput",
    "Where time goes",
  ...
  "overview/kubernetes": ["Kubernetes Insights"],
  "tools/profiler": ["Query Profiler"],
  "tools/metrics": ["Query Metrics"],
  ...
  "rbac/view": ["View Grants"],
  "rbac/users": ["Users"],
  "rbac/roles": ["Roles"],
  "rbac/profiles": ["Settings Profiles"],
  "indexes/secondary": ["Data Skipping Indexes"],
  "indexes/projections": ["Projections"],
  "indexes/create": ["Index Management"],
  "custom/dashboards": ["Dashboards"],
  "backups/lifecycle": ["Data Lifecycle"],
  "admin/profiles": ["Storage Profiles"],
  "admin/users": ["User Management"],
  "admin/cluster": ["Cluster Management"],
  "admin/app-backup": ["App Data Backup"],
  "admin/api-management": ["API Key Management"],
  "admin/channels": ["Notification Channels"],
  "admin/trusted-cas": ["Trusted certificate authorities"],
  "admin/app-config": ["App Config"],
  "custom/builder": ["Chart Builder"],
  "custom/charts": ["All Charts"],
};
...
export const PAGE_TEXT = {
  ...
  "overview/kubernetes": [
    ...
    "Replicas sharing a node.",
    "No pod disruption budget.",
    "This installation is not being reconciled.",
    "The operator is not reachable.",
    "The cluster will keep serving queries, and nothing you change will be applied.",
    "Status",
    "Task",
    "Hosts",
    "Host",
    ...
    "Object",
    "Message",
    "This pod has restarted. Turn on",
    "previous container",
    "Pod",
    "From",
    "Lines",
    ...
    "Context lines",
    "Refresh",
    "The installation as submitted",
    "After templates were merged in",
    "Case-insensitive. Try Error, Warning, or a table name.",
    "Fewer lines",
    "Lines to read",
    "More lines",
  ],
  ...
  "admin/cluster": [
    ...
    "Kubernetes",
    "Add Node",
    "Add a cluster. Click New Cluster to import one from an installation.",
    ...
    "Always connect to pods directly",
    "Always use the address above",
    ...
    "Display name",
    "Production EKS",
    "Paste the whole block. CHOps will pull out the three values.",
    "https://10.0.0.5:6443",
    "-----BEGIN CERTIFICATE-----",
    "production",
    "chops",
