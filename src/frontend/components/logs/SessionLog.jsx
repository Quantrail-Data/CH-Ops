      ...
      {filtersOpen && <Card style={{ padding: 20, marginBottom: 20 }}>
        <form onSubmit={handleSearch}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12, alignItems: 'flex-end' }}>
            ...
            <Button variant="primary" type="submit" disabled={q.loading || !probeDone}>{q.loading ? <><span className="loading-spinner"></span> Searching...</> : <><Icon className="ti ti-search"></Icon> Search</>}</Button>
          </div>
        </form>
      </Card>}
